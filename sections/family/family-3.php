            ...
            <div class="mc-row mc-mg--15">
                <div class="mg-csb mc-col-9 mc-col-sm-12 mc-pdx-15">
                    ...
                    <div class="news-thtm-2">
                        <?php 
                            $args = array( 
                                'category_name' => 'cha-me-va-con-cai',
                                'post_type'=>  'post',
                                'post_status' => 'publish',
                                'posts_per_page' => 4,
                            );
                ...
                <div class="mc-col-3 mc-col-sm-12 mc-pdx-15">
                    <div class="banner_qc_news_1">
                        <a href="<?php echo get_field("family_link_banner_qc_2"); ?>">
                            <img src="<?php echo get_field("family_banner_qc_2"); ?>" alt="<?php echo get_field("family_banner_qc_2"); ?>">
                        </a>
                    </div>
                </div>
            </div>
