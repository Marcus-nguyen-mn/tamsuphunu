<section class="fashion-4 mother-children-one">
    <div class="mc-container">
        <div class="fashion-4-contain bordr-bt-section">
                ...
                <div class="mc-row mc-mg--15">
                    ...
                    <div class="mc-col-3 mc-col-md-12 mc-pdx-15 banner_qc_news_1_hid">
                        <div class="banner_qc_news_1">
                            <a href="<?php echo get_field("mc_mth_ch_link_banner_qc_1"); ?>">
                                <img src="<?php echo get_field("mc_mth_ch_banner_qc_1"); ?>" alt="<?php echo get_field("mc_mth_ch_banner_qc_1"); ?>">
                            </a>
                        </div>
                    </div>
                </div>
