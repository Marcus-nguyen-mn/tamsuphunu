            ...
            <div class="mc-row mc-mg--15">
                ...
                <div class="mc-col-3 mc-col-sm-12 mc-pdx-15">
                    <div class="banner_qc_news_1">
                        <a href="<?php echo get_field("mc_quiz_link_banner_qc_2"); ?>">
                            <img src="<?php echo get_field("mc_quiz_banner_qc_2"); ?>" alt="<?php echo get_field("mc_quiz_banner_qc_2"); ?>">
                        </a>
                    </div>
                </div>
            </div>
