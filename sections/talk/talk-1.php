<section class="talk_one">
    <div class="mc-container">
        <div class="talk_one_contain bordr-bt-section">
            ...
            <div class="mc-row mc-mg--15">
                ...
                <div class="mc-col-3 mc-col-sm-12 mc-pdx-15 bn-fas-none">
                    <div class="banner_qc_news_1">
                        <a href="<?php echo get_field("mc_talk_link_banner_qc_1"); ?>">
                            <img src="<?php echo get_field("mc_talk_banner_qc_1"); ?>" alt="<?php echo get_field("mc_talk_banner_qc_1"); ?>">
                        </a>
                    </div>
                </div>
            </div>
